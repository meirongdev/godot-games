...
## Received a party event. This will occur when the current user's invitation request is accepted [br]
...
## p_appear_online - If the user who appear online to other users. [br]
## p_connect_timeout - The time allowed for the socket connection to be established. [br]
...
## Join the matchmaker pool and search for opponents on the server. [br]
## p_query - The matchmaker query to search for opponents. [br]
## p_min_count - The minimum number of players to compete against in a match. [br]
## p_max_count - The maximum number of players to compete against in a match. [br]
## p_string_properties - A set of key/value properties to provide to searches. [br]
## p_numeric_properties - A set of key/value numeric properties to provide to searches. [br]
## p_count_multiple - Optional multiple of the count that must be satisfied. [br]
...
## Create a multiplayer match on the server. [br]
## p_name - Optional name to use when creating the match. [br]
## Returns a task to represent the asynchronous operation.
...
## Subscribe to one or more users for their status updates. [br]
## p_user_ids - The IDs of users. [br]
## p_usernames - The usernames of the users. [br]
...
## Join a chat channel on the server. [br]
## p_target - The target channel to join. [br]
## p_type - The type of channel to join. [br]
## p_persistence - If chat messages should be stored. [br]
## p_hidden - If the current user should be hidden on the channel. [br]
...
## Join a multiplayer match with the matchmaker matched object. [br]
## p_matched - A matchmaker matched object. [br]
...
## Join a multiplayer match by ID. [br]
## p_match_id - The ID of the match to attempt to join. [br]
## p_metadata - An optional set of key-value metadata pairs to be passed to the match handler. [br]
## Returns a task which resolves to a multiplayer match.
...
## Leave a chat channel on the server. [br]
## p_channel_id - The ID of the chat channel to leave. [br]
...
## Leave a multiplayer match on the server. [br]
## p_match_id - The multiplayer match to leave. [br]
## Returns a task which represents the asynchronous operation.
...
## Remove a chat message from a chat channel on the server. [br]
## p_channel - The chat channel with the message to remove. [br]
## p_message_id - The ID of the chat message to remove. [br]
...
## Leave the matchmaker pool with the ticket. [br]
## p_ticket - The ticket returned by the matchmaker on join. [br]
## Returns a task which represents the asynchronous operation.
...
## Send input to a multiplayer match on the server. [br]
## When no presences are supplied the new match state will be sent to all presences. [br]
## p_match_id - The ID of the match. [br]
## p_op_code - An operation code for the input. [br]
## p_data - The input data to send. [br]
## p_presences - The presences in the match who should receive the input. [br]
## Returns a task which represents the asynchronous operation.
...
## Unfollow one or more users from their status updates. [br]
## p_user_ids - An array of user ids to unfollow. [br]
## Returns a task which represents the asynchronous operation.
...
## Update a chat message on a chat channel in the server. [br]
## p_channel_id - The ID of the chat channel with the message to update. [br]
## p_message_id - The ID of the message to update. [br]
## p_content - The new contents of the chat message. [br]
...
## Update the status for the current user online. [br]
## p_status - The new status for the user. [br]
## Returns a task which represents the asynchronous operation.
func update_status_async(p_status : String):
	return await _send_async(NakamaRTMessage.StatusUpdate.new(p_status)).completed

## Send a chat message to a chat channel on the server. [br]
## p_channel_id - The ID of the chat channel to send onto. [br]
## p_content - The contents of the message to send. [br]
...
## Accept a party member's request to join the party. [br]
## p_party_id - The party ID to accept the join request for. [br]
## p_presence - The presence to accept as a party member. [br]
## Returns a task to represent the asynchronous operation.
...
## Begin matchmaking as a party. [br]
## p_party_id - Party ID. [br]
## p_query - Filter query used to identify suitable users. [br]
## p_min_count - Minimum total user count to match together. [br]
## p_max_count - Maximum total user count to match together. [br]
## p_string_properties - String properties. [br]
## p_numeric_properties - Numeric properties. [br]
## p_count_multiple - Optional multiple of the count that must be satisfied. [br]
## Returns a task to represent the asynchronous operation.
...
## End a party, kicking all party members and closing it. [br]
## p_party_id - The ID of the party. [br]
## Returns a task to represent the asynchronous operation.
...
## Create a party. [br]
## p_open - Whether or not the party will require join requests to be approved by the party leader. [br]
## p_max_size - Maximum number of party members. This maximum does not include the party leader. [br]
## Returns a task to represent the asynchronous operation.
...
## Request a list of pending join requests for a party. [br]
## p_party_id - Party ID. [br]
...
## Promote a new party leader. [br]
## p_party_id - Party ID. [br]
## p_party_member - The presence of an existing party member to promote as the new leader. [br]
...
## Cancel a party matchmaking process using a ticket. [br]
## p_party_id - Party ID. [br]
## p_ticket - The ticket to cancel. [br]
## Returns a task which represents the asynchronous operation.
...
## Kick a party member, or decline a request to join. [br]
## p_party_id - Party ID to remove/reject from. [br]
## p_presence - The presence to remove or reject. [br]
## Returns a task which represents the asynchronous operation.
...
## Send data to a party. [br]
## p_party_id - Party ID to send to. [br]
## p_op_code - Op code value. [br]
## data - Data payload, if any. [br]
## Returns a task which represents the asynchronous operation.
